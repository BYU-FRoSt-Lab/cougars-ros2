...
exec(open("/home/frostlab/ros2_ws/docs/docs_build/cougars_localization/cougars_localization/default_sphinx_project/conf.py").read())
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "cougars_localization Doxygen Project": "/home/frostlab/ros2_ws/docs/docs_build/cougars_localization/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/frostlab/ros2_ws/docs/docs_build/cougars_localization/cougars_localization/wrapped_sphinx_directory/generated",
...
if rosdoc2_settings.get('automatically_extend_intersphinx_mapping', True):
    ...
    ensure_global('intersphinx_mapping', {
        'cougars_control': ('http://docs.ros.org/en/latest/p/cougars_control/', '/home/frostlab/ros2_ws/docs/cross_reference/cougars_control/objects.inv')
    })
