...
import os
import sys
sys.path.insert(0, os.path.abspath(os.path.join('/home/frostlab/ros2_ws/src/cougars_localization/scripts', '..')))
...
copyright = 'The <cougars_localization> Contributors. License: Apache-2.0'
