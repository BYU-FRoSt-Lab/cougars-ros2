...
exec(open("/home/frostlab/ros2_ws/docs/docs_build/cougars_control/cougars_control/default_sphinx_project/conf.py").read())
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "cougars_control Doxygen Project": "/home/frostlab/ros2_ws/docs/docs_build/cougars_control/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/frostlab/ros2_ws/docs/docs_build/cougars_control/cougars_control/wrapped_sphinx_directory/generated",
