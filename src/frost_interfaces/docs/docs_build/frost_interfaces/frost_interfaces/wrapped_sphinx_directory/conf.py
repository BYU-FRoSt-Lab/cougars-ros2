...
exec(open("/home/frostlab/ros2_ws/src/frost_interfaces/docs/docs_build/frost_interfaces/frost_interfaces/default_sphinx_project/conf.py").read())
...
ensure_global('project', "frost_interfaces")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['rosidl_default_runtime', 'std_msgs', 'nav_msgs']:
        try:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/frostlab/ros2_ws/src/frost_interfaces/docs/docs_build/frost_interfaces/frost_interfaces/wrapped_sphinx_directory/generated",
