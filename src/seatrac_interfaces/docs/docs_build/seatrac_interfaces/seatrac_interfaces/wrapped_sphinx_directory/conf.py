...
exec(open("/home/frostlab/ros2_ws/src/seatrac_interfaces/docs/docs_build/seatrac_interfaces/seatrac_interfaces/default_sphinx_project/conf.py").read())
...
ensure_global('project', "seatrac_interfaces")
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/frostlab/ros2_ws/src/seatrac_interfaces/docs/docs_build/seatrac_interfaces/seatrac_interfaces/wrapped_sphinx_directory/generated",
