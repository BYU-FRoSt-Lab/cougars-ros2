...
exec(open("/home/frostlab/ros2_ws/src/seatrac/docs/docs_build/seatrac/seatrac/default_sphinx_project/conf.py").read())
...
ensure_global('project', "seatrac")
ensure_global('author', """Clayton Smith""")
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['seatrac_interfaces', 'rclcpp', 'std_msgs']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "seatrac Doxygen Project": "/home/frostlab/ros2_ws/src/seatrac/docs/docs_build/seatrac/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/frostlab/ros2_ws/src/seatrac/docs/docs_build/seatrac/seatrac/wrapped_sphinx_directory/generated",
