...
exec(open("/home/frostlab/ros2_ws/src/cougars_localization/docs/docs_build/cougars_localization/cougars_control/default_sphinx_project/conf.py").read())
...
if rosdoc2_settings.get('enable_autodoc', True):
    ...
    pkgs_to_mock = []
    import importlib
    for exec_depend in ['std_msgs', 'sensor_msgs', 'geometry_msgs', 'nav_msgs', 'frost_interfaces', 'seatrac_interfaces', 'dvl_msgs', 'gps_msgs', 'ros2launch', 'rclcpp', 'rclpy']:
        try:
...
if rosdoc2_settings.get('enable_breathe', is_doxygen_invoked):
    ...
    breathe_projects.update({        "cougars_localization Doxygen Project": "/home/frostlab/ros2_ws/src/cougars_localization/docs/docs_build/cougars_localization/output_staging/generated/doxygen/xml"
    })
    if breathe_projects:
...
if rosdoc2_settings.get('enable_exhale', is_doxygen_invoked):
    ...
    exhale_args.update({
        ...
        "containmentFolder": "/home/frostlab/ros2_ws/src/cougars_localization/docs/docs_build/cougars_localization/cougars_control/wrapped_sphinx_directory/generated",
