...
case $1 in
    "manual")
        ros2 launch cougars_control manual_launch.py namespace:=$NAMESPACE config_file:=$VEHICLE_PARAM_FILE
        ;;
    "moos")
        ros2 launch cougars_control moos_launch.py namespace:=$NAMESPACE config_file:=$VEHICLE_PARAM_FILE
        ;;
    "sensors")
        ros2 launch cougars_localization sensors_launch.py namespace:=$NAMESPACE config_file:=$VEHICLE_PARAM_FILE
        ;;
    *)
